...
exports.DEFAULT_CANARY_PLAN = exports.CanaryRolloutExecutor = void 0;
const internal_cohort_rollout_1 = require("../lib/internal-cohort-rollout");
class CanaryRolloutExecutor {
    constructor(plan) {
        this.executionLog = [];
        this.plan = plan;
    ...
    async initialize() {
        try {
            ...
            this.rollout = await internal_cohort_rollout_1.InternalCohortRollout.create();
    ...
    async verifyFreezeState() {
        ...
        try {
            ...
            const targetingValid = this.plan.canaryDevices.every(spec => canaryDevices.find(d => d.id === spec.id));
    ...
    async runDeviceSmokeTests(deviceSpec) {
        const results = {
            coldStart: false,
            ttr: false,
        ...
        try {
            ...
            results.compaction = await this.measureCompaction() <= this.plan.thresholds.compactionMs;
    ...
    async notifyStakeholders(title, message) {
...
exports.CanaryRolloutExecutor = CanaryRolloutExecutor;
// Default canary execution plan
exports.DEFAULT_CANARY_PLAN = {
    canaryDevices: [
        {
