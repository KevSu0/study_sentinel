...
const canary_rollout_executor_1 = require("../lib/canary-rollout-executor");
async function executeCanaryRollout() {
    console.log('🚀 Starting canary rollout execution for Slice 1...');
    const executor = new canary_rollout_executor_1.CanaryRolloutExecutor(canary_rollout_executor_1.DEFAULT_CANARY_PLAN);
    try {
